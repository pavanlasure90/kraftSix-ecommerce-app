...
//           <Link onClick={handleLogout} className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Logout</Link>
//         </div>
//       </div>
//     </nav>
//   );
...
const Navbar = () => {
  let navigate = useNavigate();
  const { user, logOut } = useAuth(); // Get the user and logout function from useAuth hook
          ...
          <div className="hidden md:flex">
            <div className="ml-4 flex items-center md:ml-auto space-x-4">
              ...
              {user ? ( // Check if user is authenticated
                <Link onClick={handleLogout} className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Logout</Link>
              ) : (
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          {user ? ( // Check if user is authenticated
            ...
            <Link to="/" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Login</Link>
          )}
        </div>
      </div>
    </nav>
